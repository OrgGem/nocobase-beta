...
export const JobsTab = () => {
  ...
  return (
    <div>
      ...
      <Table rowKey="id" columns={columns} dataSource={data} loading={loading} size="small" pagination={{ pageSize: 20 }} />

      <Drawer
        title={activeJob ? `Job #${activeJob.id} — ${pipelineMap.get(activeJob.pipelineId) || 'Unknown'}` : 'Job Details'}
        width={640}
        open={drawerVisible}
      ...
      >
        {activeJob && (
          <div>
            ...
            <pre style={{ background: '#f0f5ff', padding: 12, borderRadius: 6, fontSize: 12, maxHeight: 300, overflow: 'auto' }}>
