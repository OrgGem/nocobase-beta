...
// upstream plugin's internal chart-editor component, config store, and query-builder service.
// There is no public API for these symbols; changes upstream may require updates here.
import { ChartOptionsEditor } from '@nocobase/plugin-data-visualization/src/client-v2/flow/models/ChartOptionsEditor';
import { configStore } from '@nocobase/plugin-data-visualization/src/client-v2/flow/models/config-store';
import { getFieldOptions } from '@nocobase/plugin-data-visualization/src/client-v2/flow/models/QueryBuilder.service';
import { observer, useFlowSettingsContext } from '@nocobase/flow-engine';

import { ChartOptionsBuilder } from './ChartOptionsBuilderCompat';
import { useCompile, useDataVisualizationT } from './utils';
