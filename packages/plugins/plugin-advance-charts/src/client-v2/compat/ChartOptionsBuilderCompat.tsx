...
// upstream plugin's internal chart-configuration system. There is no public API for
// these symbols; changes upstream may require updates here.
import {
  normalizeBuilder,
  applyTypeChange,
  buildFieldOptions,
  getChartFormSpec,
} from '@nocobase/plugin-data-visualization/src/client-v2/flow/models/ChartOptionsBuilder.service';
import type { ChartTypeKey } from '@nocobase/plugin-data-visualization/src/client-v2/flow/models/ChartOptionsBuilder.service';
import { useFlowSettingsContext } from '@nocobase/flow-engine';
import type { FieldOption } from '@nocobase/plugin-data-visualization/client-v2';

import { useChartsCompat, useDefaultChartTypeCompat } from './dataVisualizationPlugin';
import { appendColon, sleep, useCompile, useDataVisualizationT } from './utils';
...
export const ChartOptionsBuilder: React.FC<{
  ...
  const charts = useChartsCompat();
  const defaultRegisteredChartType = useDefaultChartTypeCompat();
