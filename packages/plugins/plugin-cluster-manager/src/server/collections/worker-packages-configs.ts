...
export default {
  name: 'workerPackagesConfigs',
  title: 'Worker Packages Configs',
  fields: [
    ...
    // Package/module installation plan. One package per line or comma-separated.
    { name: 'aptPackages', type: 'text', allowNull: true },
    { name: 'pythonPackages', type: 'text', allowNull: true },
    { name: 'npmPackages', type: 'text', allowNull: true },
