...
class MarkItDown:
    ...
    def __init__(
        ...
        **kwargs,
        ...
        # NocoBase vendor patch: allow the bundled source to run without the
        # heavy magika/numpy/onnxruntime dependency chain. In that case,
        # conversion relies on filename extension and mimetype guesses only.
