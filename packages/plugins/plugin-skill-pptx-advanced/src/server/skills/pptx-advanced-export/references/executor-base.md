...
```bash
ls .agent/skills/gen-doc-ppt-master/templates/icons/chunk/ | grep home
ls .agent/skills/gen-doc-ppt-master/templates/icons/tabler-filled/ | grep home
ls .agent/skills/gen-doc-ppt-master/templates/icons/tabler-outline/ | grep chart
```
