...
```bash
python3 .agent/skills/gen-doc-ppt-master/scripts/pptx_template_import.py "<reference_template.pptx>"
```
...
```bash
mkdir -p ".agent/skills/gen-doc-ppt-master/templates/layouts/<template_id>"
```

> **Output location**: Global templates go to `.agent/skills/gen-doc-ppt-master/templates/layouts/`; project templates go to `projects/<project>/templates/`
>
...
```bash
ls -la ".agent/skills/gen-doc-ppt-master/templates/layouts/<template_id>"
```

Run SVG validation on the template directory:

```bash
python3 .agent/skills/gen-doc-ppt-master/scripts/svg_quality_checker.py ".agent/skills/gen-doc-ppt-master/templates/layouts/<template_id>" --format <canvas_format>
```
...
Update `.agent/skills/gen-doc-ppt-master/templates/layouts/layouts_index.json`:
...
**Template Path**: `.agent/skills/gen-doc-ppt-master/templates/layouts/<template_id>/`
**Category**: <category>
