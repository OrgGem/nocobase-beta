...
description: >
  ...
  "生成PPT", "做PPT", "制作演示文稿", or mentions "gen-doc-ppt-master".
---

# Gen-Doc PPT Master Skill
...
>
> - `gen-doc-ppt-master` is a repository-specific workflow skill, not a general application scaffold
...
> - **♻️ Auto-Install Dependencies**: If any python script encounters `ModuleNotFoundError` or `ImportError`, you MUST immediately Auto-Install dependencies without asking the user by running: `pip install -r .agent/skills/gen-doc-ppt-master/requirements.txt --quiet` and then retry the script!
